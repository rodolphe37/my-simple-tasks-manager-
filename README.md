...
>
>You have to resize your window like the animated gif below (with the graphs in large size (by reducing the width of your window before clicking on the png >button)) because the png file is generated automatically with the scale of your window (if you use this option in full screen, your image will be all >crushed.
